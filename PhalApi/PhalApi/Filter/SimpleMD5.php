...
class PhalApi_Filter_SimpleMD5 implements PhalApi_Filter {
    ...
    public function check() {
	    ...
	    $allParams = array_diff_assoc($allParams,$_COOKIE);
    ...
    protected function encryptAppKey($params) {
		...
		//echo $paramsStrExceptSign."<br>";
        //echo md5($paramsStrExceptSign)."<br>";
	    //DI()->logger->debug('params', array('needSign' => $paramsStrExceptSign));
