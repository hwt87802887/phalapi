...
echo "<h2 class='ui header'>接口：$service</h2><br/><span class='ui teal tag label'>$description</span> <div class='ui raised segment'> <span class='ui red ribbon label'>接口说明</span>";
echo "<div class=\"ui message\"><p>$descComment</p></div></div>";
...
<p>&copy; Powered  By <a href="#" target="_blank">小说 {$version}</a> <p>
